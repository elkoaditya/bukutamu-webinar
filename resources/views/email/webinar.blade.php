                            ...
                            <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                <tr>
                                    <td class="sm-px-24" style="--bg-opacity: 1; background-color: #ffffff; background-color: rgba(255, 255, 255, var(--bg-opacity)); border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; --text-opacity: 1; color: #626262; color: rgba(98, 98, 98, var(--text-opacity));" bgcolor="rgba(255, 255, 255, var(--bg-opacity))" align="left">
                                        <p style="font-weight: 600; font-size: 18px; margin-bottom: 0;">Selamat datang</p>
                                        <p style="font-weight: 700; font-size: 20px; margin-top: 0; --text-opacity: 1; color: #ff5850; color: rgba(255, 88, 80, var(--text-opacity));">{{$data->namaSekolah}}</p>
                                        <p style="margin: 0 0 24px;">
                                            Terima kasih telah melakukan pendaftaran Trial Afresto System.
                                        </p>
                                        <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                            <tr>
...
{{--                                                                <strong>Tanggal Pelaksanaan :</strong> Rabu, 18 Mei 2022--}}
{{--                                                            </td>--}}
{{--                                                        </tr>--}}
{{--                                                        <tr>--}}
{{--                                                            <td style="font-family: 'Montserrat',Arial,sans-serif; font-size: 14px;">--}}
{{--                                                                <strong>Waktu :</strong> 09.00 WITA - SELESAI--}}
{{--                                                            </td>--}}
{{--                                                        </tr>--}}
{{--                                                        <tr>--}}
{{--                                                            <td style="font-family: 'Montserrat',Arial,sans-serif; font-size: 14px;">--}}
{{--                                                                <strong>Sarana Tempat :</strong> Zoom Meeting--}}
{{--                                                            </td>--}}
{{--                                                        </tr>--}}
{{--                                                        <tr>--}}
{{--                                                            <td style="font-family: 'Montserrat',Arial,sans-serif; font-size: 14px;">--}}
{{--                                                                <strong>Tema :</strong> Peran Digitalisasi Dalam Proses Pembelajaran Untuk Mewujudkan SDM Bali Unggul, Cerdas dan Berkarakter--}}
{{--                                                            </td>--}}
{{--                                                        </tr>--}}
{{--                                                    </table>--}}
                                                </td>
                                            ...
                                            <tr>
                                                <td colspan="2" style="font-family: 'Montserrat',Arial,sans-serif;">
                                                    <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                                        ...
                                                        <tr>
                                                            <td style="font-family: 'Montserrat',Arial,sans-serif; font-size: 14px; padding-top: 10px; padding-bottom: 10px; width: 50%;" >
                                                                Nama Sekolah
                                                            </td>
                                                            <td align="right" style="font-family: 'Montserrat',Arial,sans-serif; font-size: 14px; text-align: right; width: 50%;" >
                                                                {{$data->namaSekolah}}</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="font-family: 'Montserrat',Arial,sans-serif; font-size: 14px; padding-top: 10px; padding-bottom: 10px; width: 50%;" >
                                                            ...
                                                            <td align="right" style="font-family: 'Montserrat',Arial,sans-serif; font-size: 14px; text-align: right; width: 50%;" >J{{$data->alamatSekolah}}</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="font-family: 'Montserrat',Arial,sans-serif; font-size: 14px; padding-top: 10px; padding-bottom: 10px; width: 50%;" >
                                                                Email
                                                            </td>
                                                            <td align="right" style="font-family: 'Montserrat',Arial,sans-serif; font-size: 14px; text-align: right; width: 50%;" >{{$data->email}}</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="font-family: 'Montserrat',Arial,sans-serif; font-size: 14px; padding-top: 10px; padding-bottom: 10px; width: 50%;" >
                                                                Nama Kepala Sekolah
                                                            </td>
                                                            <td align="right" style="font-family: 'Montserrat',Arial,sans-serif; font-size: 14px; text-align: right; width: 50%;" >{{$data->namaKepalaSekolah}}</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="font-family: 'Montserrat',Arial,sans-serif; font-size: 14px; padding-top: 10px; padding-bottom: 10px; width: 50%;" >
                                                                Nomor Telepon Kepala Sekolah
                                                            </td>
                                                            <td align="right" style="font-family: 'Montserrat',Arial,sans-serif; font-size: 14px; text-align: right; width: 50%;" >{{$data->notelpKapsek}}</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="font-family: 'Montserrat',Arial,sans-serif; font-size: 14px; padding-top: 10px; padding-bottom: 10px; width: 50%;" >
                                                                Meeting ID
                                                            </td>
                                                            <td align="right" style="font-family: 'Montserrat',Arial,sans-serif; font-size: 14px; text-align: right; width: 50%;" >670 094 1240</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="font-family: 'Montserrat',Arial,sans-serif; font-size: 14px; padding-top: 10px; padding-bottom: 10px; width: 50%;" >
                                                                Passcode
                                                            </td>
                                                            <td align="right" style="font-family: 'Montserrat',Arial,sans-serif; font-size: 14px; text-align: right; width: 50%;" >goDigiBali</td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
...
{{--                                                                <a href="{{$link_zoom->value}}" style="display: block; font-weight: 600; font-size: 14px; line-height: 100%; padding: 16px 24px; --text-opacity: 1; color: #ffffff; color: rgba(255, 255, 255, var(--text-opacity)); text-decoration: none;">Link Zoom &rarr;</a>--}}
{{--                                                            </td>--}}
{{--                                                        </tr>--}}
{{--                                                    </table>--}}
                                                </td>
                                        ...
                                        <p style="font-size: 14px; line-height: 24px; margin-top: 6px; margin-bottom: 20px;">
                                            Apa bila anda merasa tidak melakukan pendaftaran webinar ini, silahkan hubungi kami
                                            <a href="mailto:office@afresto.id">support team</a> untuk bantuan selanjutnya.
                                        </p>
                                        <p style="font-size: 14px; line-height: 24px; margin-top: 6px; margin-bottom: 20px;">
                                            Salam Teknologi,
                                            <br>Afresto System Indonesia
                                        </p>
                                    </td>
                                </tr>
                            </table>
